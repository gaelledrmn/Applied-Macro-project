...
parameters beta delta alpha sigmaC sigmaL delta_N chi phi gy b  Gam eta gamma epsilon kappa rho phi_y phi_pi xi
			tau0 y0 sig theta1 theta2 varphi A piss  rho_a rho_g rho_c rho_m rho_i rho_r rho_t u0;
...
%    varphi,				0.2,   		,		,		gamma_pdf,			4,				1.5;
%	piss,				1.005,   		,		,		gamma_pdf,			4,				1.5;
%	sigmaL,				2,   	 	,		,		normal_pdf,			2,				0.5;

    
	%chi,					106,    	0,		,		normal_pdf,			100,				15;
	%b,				.45,    	,		,		normal_pdf,			.75,				0.1;
%	Gam,				1.8,    	,		,		normal_pdf,			1.5,				0.25;
%	A,				0.05,    	,		,		normal_pdf,			0.12,				0.05;

%    phi,                0.05,       ,       ,       gamma_pdf,          0.01,               0.01;
%    gamma,              0.85,       ,       ,       normal_pdf,         1,                1;
%    eta,                0.5,       ,       ,       normal_pdf,         1,               1;
%    delta_N,             0.1,       ,       ,       normal_pdf,         1,               1;
end;
...
stoch_simul(irf=0,order=1) y c i pi r u x mu ; % ATTENTION J AI MIS LE CHOC A RIEN 
