...
residual = zeros(40, 1);
    ...
    residual(6) = (y(8)*y(38)) - (y(7)-y(7)*(1-params(2)));
    residual(7) = ((1-params(2))*y(13)+y(6)*params(3)*y(28)/y(7)) - (y(1)*y(13));
    residual(8) = (y(38)*y(13)) - (1+params(15)/2*y(38)*y(13)*(1+(-y(8))/y(8)));
...
residual(11) = 1-params(14)+params(14)*y(10)-params(26)*y(11)*(y(11)-(y(11)))+(y(11)-(y(11)))*y(11)*params(1)*params(26);
    residual(12) = (y(15)*(1-y(37)*params(12))) - (y(16)*y(37)*params(12));
    ...
    residual(19) = (y(12)) - (T(9)*T(16)*y(39));
    residual(20) = (y(19)) - ((y(6))*params(9)*y(35));
    residual(21) = (y(20)) - (params(19)*y(40));
residual(22) = y(21);
residual(23) = y(22);
residual(24) = y(23);
    ...
    residual(29) = (y(29)) - (log(T(13)));
    residual(30) = (y(31)) - (log(y(2)/(y(2))));
    residual(31) = (y(30)) - (log(y(8)/(y(8))));
    residual(32) = (y(32)) - (log(T(10)));
    residual(33) = (y(33)) - (log(y(12)/(y(12))));
    residual(34) = (log(y(34))) - (log(y(34))*params(28)+x(1));
    residual(35) = (log(y(35))) - (log(y(35))*params(29)+x(2));
    residual(36) = (log(y(36))) - (log(y(36))*params(30)+x(3));
    residual(37) = (log(y(38))) - (log(y(38))*params(32)+x(5));
    residual(38) = (log(y(37))) - (log(y(37))*params(31)+x(4));
    residual(39) = (log(y(39))) - (log(y(39))*params(33)+x(6));
    residual(40) = (log(y(40))) - (log(y(40))*params(34)+x(7));
